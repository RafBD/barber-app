    ...
    return (
        <div className="scroll-smooth">
            ...
            <header className="contenedor">
                ...
                <p class="mb-6 text-lg font-normal text-white lg:text-xl sm:px-16 xl:px-48">
                    Tu lugar de confianza para un corte de cabello y afeitado
                </p>
                <a href="/" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-[#CA8A04] rounded-lg hover:bg-[#ca8b04d2]">
