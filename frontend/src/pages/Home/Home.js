    ...
    return (
        <div className="scroll-smooth">
            ...
            <header className="contenedor">
                ...
                <a href="/servicios" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-[#422f06] bg-[#eaa108] rounded-lg hover:bg-[#ca8a04]">
